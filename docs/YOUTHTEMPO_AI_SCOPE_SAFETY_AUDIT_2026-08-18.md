...
下文把 14–17 岁有效同意等同于学校核验监护人确认，是 2026-08-18 的学校试点方案快照。当前已批准独立的学生自主试用依据：只接收 14 岁及以上学生；14–17 岁完成本人敏感信息与 AI 处理单独确认后，可使用本人生成与保存功能。该依据记录为 `student_self_pilot`，不创建学校、老师或监护人关系；正式学校试点必须启用新的同意版本并重新审核适用确认。其他 AI 安全与治理条件保持不变。
