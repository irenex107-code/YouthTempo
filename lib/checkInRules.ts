...
const affectedPatterns: Record<string, RegExp> = {
  sleep: /不太好|很不好|容易醒|入睡困难|睡得很乱|少于 5 小时|5 小时以上、不足 6 小时|5-6 小时/u,
  wake: /有点疲惫|很疲惫|紧张或烦躁|不想开始今天|有点困难|很难开始/u,
  eat: /不太规律|很不规律|1 餐|没有吃正餐|有一餐不太规律|时间比较乱|几乎没有好好吃饭|一餐|吃得比较零散/u,
  exercise: /(?:^|\s)(?:0 分钟|1–9 分钟)(?:\s|$)|几乎没有活动|5–10 分钟/u,
  task: /不太顺利|很不顺利|开始有点困难|很难开始|一直拖着|几乎没有投入/u,
};
